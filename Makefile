...
SOURCES=functional_morphogenesis.c util.c

#name of the executable file
EXECUTABLE=functional_morphogenesis
...
CFLAGS = -mmcu=atmega328p -Wall -gdwarf-2 -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums -Os
